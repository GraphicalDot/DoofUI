...
define(function (require) {
    ...
    var ApplicationPage = Marionette.LayoutView.extend({
        ...
        regions: {
            search: '.search', list: '.list', map: '.map', detail: '.detail', feedback: '.feedback', 'profile-box': '.profile-box', header: '.header__nav-menu-user-info'
        },
        initialize: function (opts) {
			...
			// 	if(self.fetchXhr.readyState > 0 && self.fetchXhr.readyState < 4){
			// 		// self.fetchXhr.abort();
			// 	}
